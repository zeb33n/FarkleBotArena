...
int main() {
  int socketfd = socket(AF_INET, SOCK_STREAM, 0); //what does AF_INET // what does 0 mean here
  ...
  struct pollfd fds[2] = {{0, POLLIN, 0}, {socketfd, POLLIN, 0}}; //what does POLLIN mean
